...
program main
  ...
  integer,parameter :: n_x = 251, n_y =126, SAVE=1,PLOT=1,PLOTVAL=4,VIDEO=0, QUIET=1
  real, parameter :: starty = 0, endy = 0.3, startx = 0, endx = 1, gamma = 1.4
  real :: delx,dely,dt,cfl,tend,lambda_0,t,dt_0,lambda,delta,Re,Suth,residual,Cv
  real :: Pr
  integer :: I,id=0,check,case_id=7,skips=10
